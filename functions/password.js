...
exports.changePassword = (database,email, password, newPassword) => 

	new Promise((resolve, reject) => {

		database.user.find({ email: email })
...
exports.resetPasswordInit = (database,email) =>
...
exports.resetPasswordFinish = (database,email, token, password) => 
